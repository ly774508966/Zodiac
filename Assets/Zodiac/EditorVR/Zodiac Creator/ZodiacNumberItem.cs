...
{
	sealed class ZodiacNumberItem : ZodiacPropertyItem
	{
		[SerializeField]
		...
		void UpdateInputField ()
		{
			...
			val = memberMono.GetBoxedData ().ToString ();
