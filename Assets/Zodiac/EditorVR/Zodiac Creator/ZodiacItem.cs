/*This is a direct copy of the InspectorComponentItem class
 * used because component items handle UnityEngine Objects with properties/fields nicely
 * changes:
 * text = target.name
*/
...
namespace Zodiac.EditorVR
{
	...
	class ZodiacItem : InspectorListItem
	{
		...
		public override void Setup (InspectorData data)
		{
			...
			var target = (ScriptableBase)data.serializedObject.targetObject;
			...
			//too soon
			//if (this.GetType () == typeof(ZodiacItem))
			//	ToggleExpanded ();
		}
